...
/**
 * Scaffold a new Vue application with Vite in the apps folder
 * Usage: node scripts/scaffold-vue.mjs <project-name>
 */
...
console.log(`Scaffolding Vue app "${projectName}" in ${directory}...`);
