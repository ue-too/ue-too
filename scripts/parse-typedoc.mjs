...
if(localizeCode == undefined){
    console.error("No localization code provided. Exiting...");
    process.exit(1);
}

console.log("lang code is:", localizeCode);
...
writeFileSync(resolve(`jsons/${localizeCode}`, `translation-${localizeCode}.json`), JSON.stringify(translationList, null, 2));
