                ...
                transitions: [
                    {
                        ...
                        action: context => {
                            console.log(
                                `Timer stopped. Elapsed: ${context.elapsed}ms`
                            );
                        },
                    },
                    {
                ...
                transitions: [
                    {
                        ...
                        action: context => {
                            const pauseDuration =
                                Date.now() - context.pausedTime;
                            console.log(
                                `Resumed after ${pauseDuration}ms pause`
                            );
                        },
                    },
                    {
                        ...
                        action: context => {
                            console.log(
                                `Timer stopped from paused state. Total elapsed: ${context.elapsed}ms`
                            );
                        },
                    },
                ],
...
const vendingSchema: StateMachineSchema<
    VendingContext,
    VendingEvents,
    VendingStates
> = {
...
const vendingMachine = createStateMachineFromSchema(
    vendingSchema,
    vendingContext
);
...
const paymentSchema: StateMachineSchema<
    PaymentContext,
    PaymentEvents,
    PaymentStates
> = {
            ...
            transitions: [
                {
                    ...
                    action: (context, payload) => {
                        ...
                        console.log(
                            `Selected item. Price: $${context.itemPrice}`
                        );
                    },
                },
            ],
            ...
            transitions: [
                {
                    ...
                    action: context => {
                        ...
                        console.log(
                            `Discount applied. New price: $${context.itemPrice.toFixed(2)}`
                        );
                    },
                },
                {
                    ...
                    action: (context, payload) => {
                        ...
                        console.log(
                            `Paid $${payload.amount}. Balance: $${context.balance}`
                        );
                    },
                    /**
...
const paymentMachine = createStateMachineFromSchema(
    paymentSchema,
    paymentContext
);
...
const calculatorSchema: StateMachineSchema<
    CalculatorContext,
    CalculatorEvents,
    CalculatorStates,
    CalculatorOutputs
