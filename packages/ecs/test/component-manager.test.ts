...
describe('ComponentManager', () => {
    ...
    it('should be idempotent when registering the same component twice', () => {
        ...
        const entity = 0;
        componentManager.addComponentToEntity(MOCK_COMPONENT, entity, {name: 'John', age: 30});
        expect(componentManager.getComponentFromEntity(MOCK_COMPONENT, entity)).toEqual({name: 'John', age: 30});
        ...
        const componentAfterReRegister = componentManager.getComponentFromEntity(MOCK_COMPONENT, entity);
