...
export function decomposeCameraMatrix(
...
function decomposeCameraMatrixVerbose(
    transformMatrix: TransformationMatrix,
    devicePixelRatio: number,
    canvasWidth: number,
    canvasHeight: number
    ...
    console.log(
        `After removing DPR: [${unscaledTx.toFixed(3)}, ${unscaledTy.toFixed(3)}]`
    );
    ...
    console.log(
        `After removing canvas center: [${adjustedTx.toFixed(3)}, ${adjustedTy.toFixed(3)}]`
    );
    ...
    console.log(
        `After inverse rotation: [${rotatedBackX.toFixed(3)}, ${rotatedBackY.toFixed(3)}]`
    );
    ...
    console.log(
        `Final camera position: [${cameraX.toFixed(3)}, ${cameraY.toFixed(3)}]`
    );
...
function testDecomposition() {
    ...
    console.log(
        `Position: (${originalCamera.position.x}, ${originalCamera.position.y})`
    );
    console.log(`Zoom: ${originalCamera.zoom}`);
    console.log(
        `Rotation: ${((originalCamera.rotation * 180) / Math.PI).toFixed(2)}°`
    );
    ...
    console.log(
        `Position: (${decomposed.position.x.toFixed(3)}, ${decomposed.position.y.toFixed(3)})`
    );
    console.log(`Zoom: ${decomposed.zoom.toFixed(3)}`);
    console.log(
        `Rotation: ${((decomposed.rotation * 180) / Math.PI).toFixed(2)}°`
    );
