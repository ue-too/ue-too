...
describe('ValueComparisonPrecondition', () => {
    ...
    describe('with typed components', () => {
        ...
        it('should check greater than using new typed API', () => {
            const precondition =
                new ValueComparisonPrecondition<HealthComponent>(
                    coordinator,
                    HEALTH_COMPONENT_TYPED,
                    entity,
                    'health',
    ...
    describe('unified effect behavior', () => {
        ...
        it('should handle zero values correctly', () => {
            const schema: ComponentSchema = {
                componentName: HEALTH_COMPONENT_SCHEMA,
                fields: [{ name: 'health', type: 'number', defaultValue: 0 }],
            };
            coordinator.registerComponentWithSchema(schema);
            const component = coordinator.createComponentFromSchema(
                HEALTH_COMPONENT_SCHEMA,
    ...
    describe('all operators', () => {
        ...
        it('should work with > operator', () => {
            ...
            expect(precondition.check()).toBe(true);
            const precondition2 = new ValueComparisonPrecondition(
                150,
                '>',
                coordinator,
                HEALTH_COMPONENT_SCHEMA,
        ...
        it('should work with >= operator', () => {
            ...
            const precondition3 = new ValueComparisonPrecondition(
                150,
                '>=',
                coordinator,
                HEALTH_COMPONENT_SCHEMA,
