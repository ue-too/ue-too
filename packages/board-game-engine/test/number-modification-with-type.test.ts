    ...
    describe('apply', () => {
        describe('add operation', () => {
            it('should add the specified amount to a number field', () => {
                coordinator.registerComponent<HealthComponent>(HEALTH_COMPONENT);
                const component: HealthComponent = { health: 100, maxHealth: 100 };
                coordinator.addComponentToEntity(HEALTH_COMPONENT, entity, component);
                ...
                const updatedComponent = coordinator.getComponentFromEntity<HealthComponent>(HEALTH_COMPONENT, entity);
        ...
        describe('subtract operation', () => {
            ...
            it('should handle negative subtractions (adding to the value)', () => {
                coordinator.registerComponent<HealthComponent>(HEALTH_COMPONENT);
                const component: HealthComponent = { health: 50, maxHealth: 100 };
                coordinator.addComponentToEntity(HEALTH_COMPONENT, entity, component);
        ...
        describe('edge cases', () => {
            it('should not modify the value if the component does not exist on the entity', () => {
                ...
                const component: HealthComponent = { health: 100, maxHealth: 100 };
                coordinator.addComponentToEntity(HEALTH_COMPONENT, otherEntity, component);
                ...
                const updatedComponent = coordinator.getComponentFromEntity<HealthComponent>(HEALTH_COMPONENT, otherEntity);
            ...
            it('should not modify the value if the field value is not a number', () => {
                ...
                const component: StatsComponent = { health: 100, mana: 50, stamina: 75, name: 'Player' };
                coordinator.addComponentToEntity(STATS_COMPONENT, entity, component);
                ...
                const updatedComponent = coordinator.getComponentFromEntity<StatsComponent>(STATS_COMPONENT, entity);
            ...
            it('should work with different number fields in the same component', () => {
                ...
                const healthEffect = new NumberModificationWithType<StatsComponent>(
                    coordinator,
                    STATS_COMPONENT,
                    entity,
                    'health',
                ...
                const manaEffect = new NumberModificationWithType<StatsComponent>(
                    coordinator,
                    STATS_COMPONENT,
                    entity,
                    'mana',
                ...
                const staminaEffect = new NumberModificationWithType<StatsComponent>(
                    coordinator,
                    STATS_COMPONENT,
                    entity,
                    'stamina',
        ...
        describe('unified effect behavior', () => {
            ...
            it('should work correctly even if a schema exists (uses unified detection)', () => {
                ...
                const effect = new NumberModificationWithType<Record<string, unknown>>(
                    coordinator,
                    HEALTH_COMPONENT,
                    entity,
