...
describe('PlayerSystem', () => {
    ...
    describe('constructor', () => {
        ...
        it('should register PlayerComponent', () => {
            ...
            const componentType = newCoordinator.getComponentType(PLAYER_COMPONENT);
        ...
        it('should register system', () => {
            ...
            const retrievedSystem = newCoordinator.getSystem<PlayerSystem>(PLAYER_SYSTEM);
        ...
        it('should set system signature to include PlayerComponent', () => {
            ...
            newCoordinator.addComponentToEntity<PlayerComponent>(PLAYER_COMPONENT, player, {
                name: 'Test Player',
                playerNumber: 0,
                inPlay: true
            });
    ...
    describe('addPlayer', () => {
        it('should create a player entity with PlayerComponent', () => {
            ...
            const playerComponent = coordinator.getComponentFromEntity<PlayerComponent>(
                PLAYER_COMPONENT,
                player!
            );
        ...
        it('should assign sequential player numbers', () => {
            ...
            const component1 = coordinator.getComponentFromEntity<PlayerComponent>(
                PLAYER_COMPONENT,
                player1!
            );
            const component2 = coordinator.getComponentFromEntity<PlayerComponent>(
                PLAYER_COMPONENT,
                player2!
            );
    ...
    describe('removePlayer', () => {
        it('should set inPlay to false for the player', () => {
            ...
            const updatedComponent = coordinator.getComponentFromEntity<PlayerComponent>(
                PLAYER_COMPONENT,
                player!
            );
    ...
    describe('shufflePlayerOrder', () => {
        it('should shuffle player order and reassign player numbers', () => {
            ...
            const component1Before = coordinator.getComponentFromEntity<PlayerComponent>(
                PLAYER_COMPONENT,
                player1!
            );
            const component2Before = coordinator.getComponentFromEntity<PlayerComponent>(
                PLAYER_COMPONENT,
                player2!
            );
            ...
            const component1After = coordinator.getComponentFromEntity<PlayerComponent>(
                PLAYER_COMPONENT,
                player1!
            );
            const component2After = coordinator.getComponentFromEntity<PlayerComponent>(
                PLAYER_COMPONENT,
                player2!
            );
            const numbers = [component1After?.playerNumber, component2After?.playerNumber].sort();
        ...
        it('should only shuffle players with inPlay true', () => {
            ...
            coordinator.addComponentToEntity<PlayerComponent>(PLAYER_COMPONENT, player3, {
                name: 'Player 3',
                playerNumber: 2,
                inPlay: false
            });
        ...
        it('should handle single player', () => {
            ...
            const component = coordinator.getComponentFromEntity<PlayerComponent>(
                PLAYER_COMPONENT,
                player!
            );
    ...
    describe('organizePlayerOrder', () => {
        ...
        it('should only organize players with inPlay true', () => {
            ...
            const component3 = coordinator.getComponentFromEntity<PlayerComponent>(
                PLAYER_COMPONENT,
                player3
            );
    ...
    describe('setPlayerOrder', () => {
        ...
        it('should reassign sequential player numbers after setting order', () => {
            ...
            const component1 = newCoordinator.getComponentFromEntity<PlayerComponent>(
                PLAYER_COMPONENT,
                player1!
            );
            const component2 = newCoordinator.getComponentFromEntity<PlayerComponent>(
                PLAYER_COMPONENT,
                player2!
            );
            const component3 = newCoordinator.getComponentFromEntity<PlayerComponent>(
                PLAYER_COMPONENT,
                player3!
            );
            ...
            const updatedComponent1 = newCoordinator.getComponentFromEntity<PlayerComponent>(
                PLAYER_COMPONENT,
                player1!
            );
            const updatedComponent2 = newCoordinator.getComponentFromEntity<PlayerComponent>(
                PLAYER_COMPONENT,
                player2!
            );
            const updatedComponent3 = newCoordinator.getComponentFromEntity<PlayerComponent>(
                PLAYER_COMPONENT,
                player3!
            );
        ...
        it('should require array to contain all in-play players', () => {
            ...
            const component1Before = newCoordinator.getComponentFromEntity<PlayerComponent>(
                PLAYER_COMPONENT,
                player1!
            );
            const component2Before = newCoordinator.getComponentFromEntity<PlayerComponent>(
                PLAYER_COMPONENT,
                player2!
            );
            const component3Before = newCoordinator.getComponentFromEntity<PlayerComponent>(
                PLAYER_COMPONENT,
                player3!
            );
            const originalNumber1 = component1Before?.playerNumber;
            ...
            const component1After = newCoordinator.getComponentFromEntity<PlayerComponent>(
                PLAYER_COMPONENT,
                player1!
            );
            const component2After = newCoordinator.getComponentFromEntity<PlayerComponent>(
                PLAYER_COMPONENT,
                player2!
            );
            const component3After = newCoordinator.getComponentFromEntity<PlayerComponent>(
                PLAYER_COMPONENT,
                player3!
            );
        ...
        it('should call organizePlayerOrder to ensure sequential numbering', () => {
            ...
            const playerNumbers = players.map(player => {
                const component = newCoordinator.getComponentFromEntity<PlayerComponent>(
                    PLAYER_COMPONENT,
                    player
                );
                return component?.playerNumber;
        ...
        it('should do nothing when array includes out-of-play players', () => {
            ...
            coordinator.addComponentToEntity<PlayerComponent>(PLAYER_COMPONENT, playerNotInPlay, {
                name: 'Not In Play',
                playerNumber: 99,
                inPlay: false
            });
