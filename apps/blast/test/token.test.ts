...
import { StackableTokenSystem, LOCATION_COMPONENT, DECK_COMPONENT, LocationComponent, DeckComponent } from "../src/token";
...
describe('StackableTokenSystem', () => {
    ...
    beforeEach(() => {
        ...
        coordinator.addComponentToEntity<DeckComponent>(DECK_COMPONENT, deckEntity, {
            cached: { entities: [] }
        });
    });
    ...
    describe('constructor', () => {
        it('should initialize with a coordinator', () => {
            ...
            newCoordinator.registerComponent<LocationComponent>(LOCATION_COMPONENT);
        ...
        it('should register LOCATION_COMPONENT if not already registered', () => {
            ...
            newCoordinator.registerComponent<LocationComponent>(LOCATION_COMPONENT);
            const newSystem = new StackableTokenSystem(newCoordinator);
            const componentType = newCoordinator.getComponentType(LOCATION_COMPONENT);
    ...
    describe('shuffle', () => {
        it('should shuffle entities at a location', () => {
            ...
            coordinator.addComponentToEntity<LocationComponent>(LOCATION_COMPONENT, entity1, {
                location: deckEntity,
                sortIndex: 0
            });
            coordinator.addComponentToEntity<LocationComponent>(LOCATION_COMPONENT, entity2, {
                location: deckEntity,
                sortIndex: 1
            });
            coordinator.addComponentToEntity<LocationComponent>(LOCATION_COMPONENT, entity3, {
                location: deckEntity,
                sortIndex: 2
            });
            ...
            for (let i = 0; i < 10; i++) {
                ...
                const deck = coordinator.getComponentFromEntity<DeckComponent>(DECK_COMPONENT, deckEntity);
        ...
        it('should update sortIndex for all entities after shuffle', () => {
            ...
            const location1 = coordinator.getComponentFromEntity<LocationComponent>(LOCATION_COMPONENT, entity1);
            const location2 = coordinator.getComponentFromEntity<LocationComponent>(LOCATION_COMPONENT, entity2);
            ...
            const sortIndices = [location1?.sortIndex, location2?.sortIndex].sort();
        ...
        it('should only shuffle entities at the specified location', () => {
            ...
            coordinator.addComponentToEntity<DeckComponent>(DECK_COMPONENT, otherDeck, {
                cached: { entities: [] }
            });
            ...
            const deck = coordinator.getComponentFromEntity<DeckComponent>(DECK_COMPONENT, deckEntity);
            const otherDeckComponent = coordinator.getComponentFromEntity<DeckComponent>(DECK_COMPONENT, otherDeck);
        ...
        it('should throw error if location component not found for entity', () => {
            ...
            const sorted = (system as any)._getSortedEntitiesWithLocation(deckEntity);
            ...
            coordinator.removeComponentFromEntity<LocationComponent>(LOCATION_COMPONENT, entity2);
    ...
    describe('pop', () => {
        it('should pop the last entity from a deck and move it to a new location', () => {
            ...
            coordinator.addComponentToEntity<DeckComponent>(DECK_COMPONENT, toLocation, {
                cached: { entities: [] }
            });
            ...
            const location = coordinator.getComponentFromEntity<LocationComponent>(LOCATION_COMPONENT, entity2);
            expect(location?.location).toBe(toLocation);
            
            const toDeck = coordinator.getComponentFromEntity<DeckComponent>(DECK_COMPONENT, toLocation);
    ...
    describe('add', () => {
        it('should add an entity to a deck', () => {
            ...
            coordinator.addComponentToEntity<DeckComponent>(DECK_COMPONENT, otherLocation, {
                cached: { entities: [] }
            });

            coordinator.addComponentToEntity<LocationComponent>(LOCATION_COMPONENT, entity, {
        ...
        it('should set correct sortIndex when adding multiple entities to bottom', () => {
            ...
            coordinator.addComponentToEntity<LocationComponent>(LOCATION_COMPONENT, entity4, {
                location: otherLocation,
                sortIndex: 0
            });
            coordinator.addComponentToEntity<LocationComponent>(LOCATION_COMPONENT, entity5, {
                location: otherLocation,
                sortIndex: 0
            });
            ...
            const location1 = coordinator.getComponentFromEntity<LocationComponent>(LOCATION_COMPONENT, entity1);
            const location2 = coordinator.getComponentFromEntity<LocationComponent>(LOCATION_COMPONENT, entity2);
            const location3 = coordinator.getComponentFromEntity<LocationComponent>(LOCATION_COMPONENT, entity3);
            const location4 = coordinator.getComponentFromEntity<LocationComponent>(LOCATION_COMPONENT, entity4);
            const location5 = coordinator.getComponentFromEntity<LocationComponent>(LOCATION_COMPONENT, entity5);
            ...
            const deck = coordinator.getComponentFromEntity<DeckComponent>(DECK_COMPONENT, deckEntity);
            expect(deck?.cached.entities).toEqual([entity1, entity2, entity3, entity4, entity5]);
        });
        ...
        it('should add multiple entities to top of deck in correct order', () => {
            ...
            const deck = coordinator.getComponentFromEntity<DeckComponent>(DECK_COMPONENT, deckEntity);
            expect(deck?.cached.entities).toEqual([entity5, entity4, entity3, entity2, entity1]);
        });
        ...
        it('should maintain correct order when adding multiple entities to bottom of non-empty deck', () => {
            ...
            coordinator.addComponentToEntity<LocationComponent>(LOCATION_COMPONENT, existingEntity1, {
                location: otherLocation,
                sortIndex: 0
            });
            coordinator.addComponentToEntity<LocationComponent>(LOCATION_COMPONENT, existingEntity2, {
                location: otherLocation,
                sortIndex: 0
            });
            ...
            const deck = coordinator.getComponentFromEntity<DeckComponent>(DECK_COMPONENT, deckEntity);
            expect(deck?.cached.entities).toEqual([existingEntity1, existingEntity2, entity3, entity4, entity5]);
        ...
        it('should maintain correct order when adding multiple entities to top of non-empty deck', () => {
            ...
            const deck = coordinator.getComponentFromEntity<DeckComponent>(DECK_COMPONENT, deckEntity);
            expect(deck?.cached.entities).toEqual([entity5, entity4, entity3, existingEntity1, existingEntity2]);
        ...
        it('should throw error if target is not a deck', () => {
            ...
            }).toThrow(`${nonDeckEntity} is not a deck, thus cannot be added to`);
        });
        ...
        it('should throw error if entity does not have location component', () => {
            ...
            expect(() => {
                system.addToBottomOf(deckEntity, entity);
            }).toThrow(`${entity} can not be in a location, thus cannot be added to ${deckEntity}`);
        });
