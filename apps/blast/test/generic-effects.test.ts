...
describe('MoveEntity Effect', () => {
  it('should move entity from one zone to another', () => {
    ...
    const zone1Deck = coordinator.getComponentFromEntity<DeckComponent>(DECK_COMPONENT, zone1);
    const zone2Deck = coordinator.getComponentFromEntity<DeckComponent>(DECK_COMPONENT, zone2);
...
describe('ShuffleZone Effect', () => {
  it('should shuffle entities in a zone', () => {
    ...
    // Get initial order
    const deckBefore = coordinator.getComponentFromEntity<DeckComponent>(DECK_COMPONENT, zone1);
    ...
    const deckAfter = coordinator.getComponentFromEntity<DeckComponent>(DECK_COMPONENT, zone1);
...
describe('CreateEntity Effect', () => {
  ...
  it('should use dynamic component data from resolver', () => {
    ...
    const cardComp = coordinator.getComponentFromEntity<CardComponent>(CARD_COMPONENT, token);
...
describe('ConditionalEffect', () => {
  it('should apply thenEffect when condition is true', () => {
    ...
    const effect = new ConditionalEffect({
      condition: (ctx) => {
        const resource = ctx.state.coordinator.getComponentFromEntity<ResourceComponent>(
          RESOURCE_COMPONENT,
          ctx.actor
        );
  ...
  it('should apply elseEffect when condition is false', () => {
    ...
    const effect = new ConditionalEffect({
      condition: (ctx) => {
        const r = ctx.state.coordinator.getComponentFromEntity<ResourceComponent>(
          RESOURCE_COMPONENT,
          ctx.actor
        );
    ...
    const resourceAfter = coordinator.getComponentFromEntity<ResourceComponent>(
      RESOURCE_COMPONENT,
      player1
    );
