                ...
                transitions: [
                    ...
                    },
                    {
                        ...
                        guards: [
                            {
                                condition:
                                    'context.balance >= context.itemPrice',
...
export function StateMachineBuilder() {
    ...
    const [liveMachine, setLiveMachine] = useState<StateMachine<
        any,
        any,
        any
    > | null>(null);
    ...
    const updateStateName = useCallback(
            ...
            setStates(prevStates =>
                prevStates.map(s => ({
                    ...
                    transitions: s.transitions.filter(
                        t => t.targetState !== stateName
                    ),
                }))
            );
            if (initialState === stateName) {
                setInitialState(
                    states.find(s => s.name !== stateName)?.name ||
                        states[0].name
                );
            }
        },
    ...
    const updateContextField = useCallback(
        (id: number, field: keyof ContextField, value: string) => {
            if (
                field === 'name' &&
                value.trim() &&
                contextFields.some(f => f.id !== id && f.name === value.trim())
            ) {
                alert('Field name already exists');
                return;
            }
    ...
    const generateSchema = useCallback(() => {
        try {
            ...
            events.forEach(event => {
                eventPayloadMapping[event.name] =
                    Object.keys(event.payload).length > 0 ? event.payload : {};
            });
            ...
            try {
                ...
                const liveMachineInstance = createStateMachineFromSchema(
                    schema,
                    liveContext
                );
                ...
                setCurrentMachineState(
                    (liveMachineInstance as any).currentState
                );
    ...
    const generateUsageExample = (
        schema: StateMachineSchema<any, any>,
        fields: ContextField[],
        events: EventDef[]
    ): string => {
        const contextInit = fields
            .map(f => {
    ...
    return (
        <div style={{ padding: '20px', maxWidth: '1400px', margin: '0 auto' }}>
            ...
            >
                ...
                >
                    <label style={{ fontSize: '0.9em', fontWeight: 600 }}>
                        Load Example:
                    </label>
                    <select
                        onChange={e => {
            ...
            >
                ...
                >
                    ...
                    <div style={{ marginBottom: '30px' }}>
                        ...
                        >
                            <div style={{ marginBottom: '10px' }}>
                                ...
                                <input
                                    ...
                                    onChange={e =>
                                        setNewContextFieldName(e.target.value)
                                    }
                                    onKeyPress={e =>
                                        e.key === 'Enter' && addContextField()
                                    }
                            ...
                            <div style={{ marginBottom: '10px' }}>
                                ...
                                <select
                                    ...
                                    onChange={e =>
                                        setNewContextFieldType(e.target.value)
                                    }
                                    style={{
                                        width: '100%',
                                        padding: '6px',
                                ...
                                >
                                    ...
                                    <option value="array_number">
                                        Number[]
                                    </option>
                                    <option value="array_string">
                                        String[]
                                    </option>
                                    <option value="array_boolean">
                                        Boolean[]
                                    </option>
                                </select>
                            </div>
                        ...
                        {contextFields.length === 0 && (
                            ...
                            >
                                No context fields defined. Context will use
                                BaseContext only.
                            </div>
                        )}
                    </div>
                ...
                >
                    ...
                    >
                        {schemaOutput ||
                            'Click "Generate Schema" to see output'}
                    </div>
                    <button
                        onClick={copySchema}
                        ...
                        style={{
                            ...
                            border: 'none',
                            borderRadius: '8px',
                            cursor: schemaOutput ? 'pointer' : 'not-allowed',
                            opacity: schemaOutput ? 1 : 0.5,
                        }}
                    >
                        Copy Schema
                    </button>
                ...
                >
                    ...
                    {liveMachine ? (
                        <>
                            ...
                            >
                                ...
                                <ol style={{ margin: 0, paddingLeft: '20px' }}>
                                    <li>
                                        Click "Generate Schema" to create a live
                                        instance
                                    </li>
                                    <li>
                                        Modify context values directly in the
                                        inputs above
                                    </li>
                                    <li>
                                        Trigger events to see state transitions
                                    </li>
                                    <li>
                                        Watch how context data persists across
                                        states
                                    </li>
                                </ol>
                            </div>
                        ...
                        >
                            ...
                            >
                                You can then interact with the state machine and
                                manipulate context data
                            </div>
                        </div>
                    )}
                </div>
