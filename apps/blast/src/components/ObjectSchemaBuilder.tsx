...
export function ObjectSchemaBuilder() {
    ...
    const clearAll = useCallback(() => {
        if (!confirm('Clear all fields? This will not delete saved schemas.'))
            return;
        ...
        <div style={{ padding: '20px', maxWidth: '1400px', margin: '0 auto' }}>
            ...
            >
                ...
                <p style={{ opacity: 0.9, fontSize: '0.95em' }}>
                    Define custom data schemas with primitives, arrays, and
                    nested structures
                </p>
            </div>
                ...
                >
                    ...
                    <div style={{ display: 'flex', gap: '10px' }}>
                        <button
                            ...
                            disabled={
                                !schemaOutput ||
                                schemaOutput.includes('Add fields')
                            }
                            style={{
                                flex: 1,
                                padding: '10px',
