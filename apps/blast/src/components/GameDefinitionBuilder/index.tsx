...
export function GameDefinitionBuilder() {
    const [gameDefinition, setGameDefinition] = useState<BuilderGameDefinition>(
        createEmptyGameDefinition()
    );
    ...
    const updateDefinition = useCallback(
        <K extends keyof BuilderGameDefinition>(
            key: K,
    ...
    const validate = useCallback(() => {
        ...
        if (Object.keys(gameDefinition.components).length === 0)
            errors.push('At least one component is required');
        if (gameDefinition.phases.length === 0)
            errors.push('At least one phase is required');
        if (!gameDefinition.setup.perPlayer.template)
            errors.push('Player template is required');
        ...
        <div style={styles.container}>
            ...
            <div style={styles.header}>
                ...
                >
                    ...
                    <button style={styles.button} onClick={loadFromFile}>
                        Load JSON
                    </button>
                    <button style={styles.successButton} onClick={saveToFile}>
                        Save JSON
                    </button>
                </div>
            </div>
            ...
            {activeTab === 'play' && (
                <div
                    style={{ ...styles.editorPanel, flex: 1, overflow: 'auto' }}
                >
                    ...
                    <div style={styles.editorPanel}>
                        ...
                        {activeTab === 'components' && (
                            <ComponentsSection
                                ...
                                onChange={components =>
                                    updateDefinition('components', components)
                                }
                            />
                        )}
                        {activeTab === 'zones' && (
                        ...
                        {activeTab === 'actions' && (
                            <ActionsSection
                                ...
                                onChange={actions =>
                                    updateDefinition('actions', actions)
                                }
                            />
                        )}
                        {activeTab === 'phases' && (
                            <PhasesSection
                                ...
                                actions={gameDefinition.actions}
                                onChange={phases =>
                                    updateDefinition('phases', phases)
                                }
                            />
                        )}
                        {activeTab === 'rules' && (
                            <RulesSection
                                rules={
                                    (gameDefinition.rules as RuleDefinitionSchema[]) ||
                                    []
                                }
                                components={gameDefinition.components}
                                zones={gameDefinition.zones}
                        ...
                        {activeTab === 'winConditions' && (
                            <WinConditionsSection
                                winConditions={
                                    (gameDefinition.winConditions as WinConditionSchema[]) ||
                                    []
                                }
                                components={gameDefinition.components}
                                zones={gameDefinition.zones}
...
interface MetadataSectionProps {
    ...
    updateDefinition: <K extends keyof BuilderGameDefinition>(
        key: K,
        value: BuilderGameDefinition[K]
    ) => void;
}
        ...
        GridLocation: {
            ...
            properties: {
                grid: {
                    type: 'entity',
                    default: null,
                    description: 'Grid entity (null if not on grid)',
                },
                row: {
                    type: 'number',
                    default: null,
                    description: 'Square grid: row coordinate',
                },
                column: {
                    type: 'number',
                    default: null,
                    description: 'Square grid: column coordinate',
                },
                q: {
                    type: 'number',
                    default: null,
                    description: 'Hexagonal grid: q coordinate',
                },
                r: {
                    type: 'number',
                    default: null,
                    description: 'Hexagonal grid: r coordinate',
                },
            },
        },
        Location: {
            ...
            properties: {
                location: {
                    type: 'entity',
                    description: 'Zone entity this is in',
                },
                sortIndex: {
                    type: 'number',
                    default: 0,
                    description: 'Order within zone',
                },
            },
        },
        Resource: {
                ...
                <div style={{ display: 'flex', gap: '8px' }}>
                    <select
                        ...
                        onChange={e => {
                            if (
                                e.target.value &&
                                commonComponents[e.target.value]
                            ) {
                                addCommonComponent(
                                    e.target.value,
                                    commonComponents[e.target.value]
                    ...
                    <button style={styles.successButton} onClick={addComponent}>
                ...
                <div key={name} style={styles.card}>
                    ...
                    >
                        <input
                            ...
                            value={name}
                            onChange={e =>
                                renameComponent(name, e.target.value)
                            }
                            onBlur={e => {
                    ...
                    <div style={{ marginLeft: '16px' }}>
                        {Object.entries(comp.properties).map(
                            ([propName, propDef]) => (
                                <div
                                    key={propName}
                                    style={{
...
function ZonesSection({ zones, onChange }: ZonesSectionProps) {
    const addZone = () => {
        ...
        onChange({
            ...zones,
            [name]: { visibility: 'public', ordered: true, shared: false },
        });
    };
    ...
    return (
        <div>
            ...
            >
                ...
                <button style={styles.successButton} onClick={addZone}>
                    + Add Zone
                </button>
            </div>
                ...
                <div style={{ marginBottom: '20px' }}>
                    ...
                    >
                        ...
                        <span style={{ fontWeight: 'normal', color: '#999' }}>
                            ({perPlayerZones.length})
                        </span>
                    </h4>
                    {perPlayerZones.map(([name, zone]) =>
                        renderZoneCard(name, zone)
                    )}
                </div>
            )}
    ...
    const addComponentToTemplate = (
        ...
        onChange({
            ...
            [templateName]: {
                ...
                components: {
                    ...template.components,
                    [componentName]: defaultValues,
                },
            },
        });
    };

    const removeComponentFromTemplate = (
        templateName: string,
        componentName: string
    ) => {
        const template = templates[templateName];
        ...
        onChange({
            ...templates,
            [templateName]: { ...template, components: rest },
        });
    };
    ...
    return (
        <div>
            ...
            >
                ...
                <button style={styles.successButton} onClick={addTemplate}>
                    + Add Template
                </button>
            </div>
            ...
            {Object.entries(templates).map(([name, template]) => (
                <div key={name} style={styles.card}>
                    ...
                    {/* Component instances */}
                    {Object.entries(template.components).map(
                        ([compName, compData]) => (
                            <div
                                key={compName}
                                style={{
            ...
            {Object.keys(templates).length === 0 && (
                ...
                >
                    No templates defined. Templates define entity types like
                    Player, Card, etc.
                </div>
            )}
        </div>
...
const CONDITION_TYPES: {
    ...
    {
        value: 'isPlayerTurn',
        label: 'Is Player Turn',
        description: "Check if it's the actor's turn",
    },
    {
        value: 'phaseCheck',
        label: 'Phase Check',
        description: 'Check current game phase',
    },
    {
        value: 'resourceCheck',
        label: 'Resource Check',
        description: 'Check numeric resource value',
    },
    {
        value: 'entityInZone',
        label: 'Entity In Zone',
        description: 'Check if entity is in a zone',
    },
    {
        value: 'componentValueCheck',
        label: 'Component Value',
        description: 'Check component property value',
    },
    {
        value: 'ownerCheck',
        label: 'Owner Check',
        description: 'Check entity ownership',
    },
    {
        value: 'hasComponent',
        label: 'Has Component',
        description: 'Check if entity has component',
    },
    {
        value: 'zoneHasEntities',
        label: 'Zone Has Entities',
        description: 'Check zone entity count',
    },
    {
        value: 'targetCount',
        label: 'Target Count',
        description: 'Check number of targets',
    },
    {
        value: 'entityExists',
        label: 'Entity Exists',
...
function ConditionBuilder({
    ...
    const createDefaultCondition = (
        ...
        switch (type) {
            ...
            case 'phaseCheck':
                return {
                    type: 'phaseCheck',
                    phases: phases.length > 0 ? [phases[0]] : ['Main'],
                };
            case 'resourceCheck':
                return {
                    type: 'resourceCheck',
    ...
    const conditionStyle = {
        padding: '12px',
        background:
            depth === 0 ? '#f0f9ff' : depth === 1 ? '#fefce8' : '#fdf2f8',
        borderRadius: '6px',
        border:
            '1px solid ' +
            (depth === 0 ? '#bae6fd' : depth === 1 ? '#fef08a' : '#fbcfe8'),
        marginBottom: '8px',
    };
    ...
    const renderConditionFields = () => {
        switch (condition.type) {
                ...
                return (
                    <div style={styles.fieldGroup}>
                        ...
                        <input
                            style={styles.input}
                            value={
                                (condition as PhaseCheckCondition).phases?.join(
                                    ', '
                                ) || ''
                            }
                            onChange={e =>
                    ...
                    >
                        <div>
                            ...
                            <select
                                ...
                                value={rc.entity}
                                onChange={e =>
                                    updateCondition({ entity: e.target.value })
                                }
                            >
                                {getEntityExpressions(targetCount).map(e => (
                        ...
                        <div style={{ gridColumn: 'span 2' }}>
                            <label style={styles.label}>
                                Value (number or expression like
                                $component.$target.Card.cost)
                            </label>
                            <input
                                style={styles.input}
                    ...
                    >
                        ...
                        <div>
                            ...
                            <select
                                style={styles.select}
                                value={
                                    Array.isArray(eiz.zone)
                                        ? eiz.zone[0]
                                        : eiz.zone
                                }
                                onChange={e =>
                                    updateCondition({ zone: e.target.value })
                                }
                            >
                                {ZONE_EXPRESSIONS.map(z => (
                ...
                return (
                    ...
                    >
                        ...
                        <div>
                            ...
                            <select
                                style={styles.select}
                                value={oc.expectedOwner}
                                onChange={e =>
                                    updateCondition({
                                        expectedOwner: e.target.value,
                                    })
                                }
                            >
                                {getEntityExpressions(targetCount).map(e => (
                        ...
                        <div>
                            ...
                            <select
                                style={styles.select}
                                value={oc.invert ? 'true' : 'false'}
                                onChange={e =>
                                    updateCondition({
                                        invert: e.target.value === 'true',
                                    })
                                }
                            >
            ...
            case 'or':
                if (depth >= maxDepth) {
                    return (
                        <div style={{ color: '#ef4444', fontSize: '0.85em' }}>
...
const EFFECT_TYPES: {
...
}[] = [
    {
        value: 'moveEntity',
        label: 'Move Entity',
        description: 'Move an entity between zones',
    },
    {
        value: 'modifyResource',
        label: 'Modify Resource',
        description: 'Add/subtract numeric resource',
    },
    {
    ...
    },
    {
        value: 'createEntity',
        label: 'Create Entity',
        description: 'Create a new entity from template',
    },
    {
        value: 'destroyEntity',
    ...
    },
    {
        value: 'shuffleZone',
        label: 'Shuffle Zone',
        description: 'Shuffle entities in a zone',
    },
    {
        value: 'transferMultiple',
        label: 'Transfer Multiple',
        description: 'Move multiple entities between zones',
    },
    {
        value: 'emitEvent',
        label: 'Emit Event',
    ...
    },
    {
        value: 'conditional',
        label: 'Conditional',
        description: 'Execute effects based on condition',
    },
    {
        value: 'switchActivePlayer',
        label: 'Switch Active Player',
        description: 'Switch to next player',
    },
    {
        value: 'repeat',
        label: 'Repeat',
        description: 'Repeat an effect multiple times',
    },
    {
        value: 'checkTicTacToeWin',
        label: 'Check Tic-Tac-Toe Win',
        description: 'Check for tic-tac-toe win condition',
    },
];
        ...
        switch (type) {
            ...
            case 'repeat':
                return {
                    type: 'repeat',
                    times: 1,
                    effect: { type: 'emitEvent', eventType: 'CustomEvent' },
                };
        ...
        switch (effect.type) {
                    ...
                    >
                        <div>
                            ...
                            <select
                                ...
                                value={me.entity}
                                onChange={e =>
                                    updateEffect({ entity: e.target.value })
                                }
                            >
                                {getEntityExpressions(targetCount).map(e => (
                                    <option key={e} value={e}>
                        ...
                        <div>
                            ...
                            <select
                                ...
                                value={me.toZone}
                                onChange={e =>
                                    updateEffect({ toZone: e.target.value })
                                }
                            >
                                {ZONE_EXPRESSIONS.map(z => (
                                    <option key={z} value={z}>
                    ...
                    >
                        ...
                        <div>
                            ...
                            <select
                                ...
                                value={mr.component}
                                onChange={e =>
                                    updateEffect({ component: e.target.value })
                                }
                            >
                                <option value="">Select...</option>
                                {Object.keys(components).map(c => (
                        ...
                        <div>
                            ...
                            <input
                                ...
                                value={mr.property}
                                onChange={e =>
                                    updateEffect({ property: e.target.value })
                                }
                                placeholder="mana"
                            />
                        </div>
                        <div>
                            <label style={styles.label}>
                                Amount (use negative for subtract)
                            </label>
                            <input
                                style={styles.input}
                                value={String(mr.amount)}
                                onChange={e => {
                                    const num = parseFloat(e.target.value);
                                    updateEffect({
                                        amount: isNaN(num)
                ...
                return (
                    ...
                    >
                        ...
                        <div>
                            ...
                            <input
                                style={styles.input}
                                value={createEntity.storeAs ?? ''}
                                onChange={e =>
                                    updateEffect({
                                        storeAs: e.target.value || undefined,
                                    })
                                }
                                placeholder="$newEntity"
                            />
                        </div>
                        <div style={{ gridColumn: 'span 2' }}>
                            <label style={styles.label}>
            ...
            case 'destroyEntity':
                ...
                return (
                    ...
                    >
                        ...
                        <div>
                            <label style={styles.label}>
                                Discard Zone (optional)
                            </label>
                            <select
                                style={styles.select}
                                value={de.discardZone ?? ''}
                                onChange={e =>
                                    updateEffect({
                                        discardZone:
                                            e.target.value || undefined,
                ...
                return (
                    <div>
                        ...
                        <select
                            ...
                            value={sz.zone}
                            onChange={e =>
                                updateEffect({ zone: e.target.value })
                            }
                        >
                            {ZONE_EXPRESSIONS.map(z => (
                                <option key={z} value={z}>
                    ...
                    >
                        <div>
                            ...
                            <select
                                ...
                                value={tm.fromZone}
                                onChange={e =>
                                    updateEffect({ fromZone: e.target.value })
                                }
                            >
                                {ZONE_EXPRESSIONS.map(z => (
                                    <option key={z} value={z}>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                style={styles.input}
                                value={
                                    typeof tm.count === 'number' ? tm.count : ''
                                }
                                onChange={e =>
                                    updateEffect({
                    ...
                    >
                        <div>
                            ...
                            <input
                                ...
                                value={ee.eventType}
                                onChange={e =>
                                    updateEffect({ eventType: e.target.value })
                                }
                                placeholder="CardPlayed"
                            />
                        </div>
                        <div>
                            <label style={styles.label}>
                    ...
                    <div>
                        <div style={{ marginBottom: '12px' }}>
                            ...
                            <ConditionBuilder
                                ...
                                onChange={cond =>
                                    cond && updateEffect({ condition: cond })
                                }
                                components={components}
                                zones={zones}
                                phases={phases}
                        ...
                        <div style={{ marginBottom: '12px' }}>
                            <label style={styles.label}>
                                Then (effects if condition is true)
                            </label>
                            <EffectListBuilder
                                effects={condEffect.then}
                                onChange={effects =>
                                    updateEffect({ then: effects })
                                }
                                components={components}
                                zones={zones}
                                phases={phases}
                        ...
                        <div>
                            <label style={styles.label}>
                                Else (effects if condition is false)
                            </label>
                            <EffectListBuilder
            ...
            case 'checkTicTacToeWin':
                return (
                    ...
                    >
                        Checks if a player has won tic-tac-toe (3 markers in a
                        row, column, or diagonal) and sets the hasWon flag on
                    ...
                    >
                        <div>
                            ...
                            <input
                                ...
                                style={styles.input}
                                value={
                                    typeof re.times === 'number' ? re.times : ''
                                }
                                onChange={e =>
                                    updateEffect({
        ...
        <div style={effectStyle}>
            ...
            >
                <select
                    ...
                    onChange={e =>
                        onChange(
                            createDefaultEffect(e.target.value as EffectType)
                        )
                    }
                >
                    {EFFECT_TYPES.map(et => (
        ...
        <div>
            ...
            <button
                ...
                onClick={() =>
                    onChange([
                        ...effects,
                        { type: 'emitEvent', eventType: 'CustomEvent' },
                    ])
                }
            >
                + Add Effect
...
function ActionsSection({
    ...
    const updateAction = (
        index: number,
        updates: Partial<ActionDefinitionSchema>
    ) => {
        onChange(
    ...
    return (
        <div>
            ...
            >
                ...
                <button style={styles.successButton} onClick={addAction}>
                    + Add Action
                </button>
            </div>
                ...
                <div key={index} style={styles.card}>
                    ...
                    >
                        ...
                        <button
                            ...
                            onClick={() =>
                                setExpandedAction(
                                    expandedAction === index ? null : index
                                )
                            }
                        >
                    ...
                    >
                        ...
                        <div>
                            ...
                            <input
                                ...
                                style={styles.input}
                                value={
                                    typeof action.targeting?.count === 'number'
                                        ? action.targeting.count
                                        : 0
                                }
                                onChange={e =>
                                    updateAction(index, {
                    ...
                    {expandedAction !== index && (
                        <div
                            ...
                            onClick={() => setExpandedAction(index)}
                        >
                            Preconditions: {action.preconditions?.length || 0} |
                            Effects: {action.effects?.length || 0} | Costs:{' '}
                    ...
                    {expandedAction === index && (
                        ...
                        >
                            ...
                            <div style={{ marginBottom: '20px' }}>
                                ...
                                >
                                    Conditions that must be true for this action
                                    to be valid
                                </div>
                                    ...
                                    (precond, pIndex) => (
                                        <ConditionBuilder
                                            ...
                                            onChange={newCond => {
                                                ...
                                                if (newCond) {
                                                    newPreconditions[pIndex] =
                                                        newCond;
                                                } else {
                                                    newPreconditions.splice(
                                                        pIndex,
                                                        1
                                                    );
                                                }
                                ...
                                {(!action.preconditions ||
                                    ...
                                    >
                                        No preconditions. Click "+ Add" to add
                                        one.
                                    </div>
                                )}
                            </div>
                            ...
                            <div style={{ marginBottom: '20px' }}>
                                ...
                                >
                                    Effects applied before the main effects
                                    (e.g., pay mana). If costs fail, action is
                                    cancelled.
                                </div>
                                <EffectListBuilder
                                    effects={action.costs || []}
                                    onChange={costs =>
                                        updateAction(index, { costs })
                                    }
                                    components={components}
                                    zones={zones}
                                    phases={phaseNames}
                                    targetCount={
                                        typeof action.targeting?.count ===
                                        'number'
                                            ? action.targeting.count
                                            : undefined
                                    }
            ...
            {actions.length === 0 && (
                ...
                >
                    No actions defined. Actions are what players can do
                    (DrawCard, PlayCard, etc.)
                </div>
            )}
        </div>
    );
...
function PhasesSection({ phases, actions, onChange }: PhasesSectionProps) {
    ...
    const updatePhase = (
        index: number,
        updates: Partial<PhaseDefinitionSchema>
    ) => {
        onChange(
            phases.map((p, i) => (i === index ? { ...p, ...updates } : p))
        );
    };
    ...
    return (
        <div>
            ...
            >
                ...
                <button style={styles.successButton} onClick={addPhase}>
                    + Add Phase
                </button>
            </div>
                    ...
                    >
                        <div>
                            ...
                            <select
                                style={styles.select}
                                value={
                                    typeof phase.nextPhase === 'string'
                                        ? phase.nextPhase
                                        : ''
                                }
                                onChange={e =>
                                    updatePhase(index, {
                                        nextPhase: e.target.value,
                                    })
                                }
                            >
                        ...
                        <div>
                            ...
                            <select
                                ...
                                onChange={e =>
                                    updatePhase(index, {
                                        autoAdvance: e.target.value === 'true',
                                    })
                                }
                            >
                            ...
                            {actions.map(action => (
                                <button
                                    ...
                                    style={{
                                        padding: '6px 12px',
                                        background:
                                            phase.allowedActions?.includes(
                                                action.name
                                            )
                                                ? '#667eea'
                                                : '#e5e7eb',
                                        color: phase.allowedActions?.includes(
                                            action.name
                                        )
                                            ? 'white'
                                            : '#374151',
                                    ...
                                    onClick={() =>
                                        toggleAction(index, action.name)
                                    }
                                >
                                    {action.name}
                                </button>
            ...
            {phases.length === 0 && (
                ...
                >
                    No phases defined. Phases control game flow (Setup, Main,
                    Combat, End, etc.)
                </div>
            )}
        </div>
...
function RulesSection({
    ...
    const updateRule = (
        index: number,
        updates: Partial<RuleDefinitionSchema>
    ) => {
    ...
    const updateTrigger = (
        index: number,
        updates: Partial<EventPatternSchema>
    ) => {
    ...
    return (
        <div>
            ...
            >
                ...
                <button style={styles.successButton} onClick={addRule}>
                    + Add Rule
                </button>
            </div>
                ...
                <div key={index} style={styles.card}>
                    ...
                    {expandedRule !== index && (
                        <div
                            ...
                            onClick={() => setExpandedRule(index)}
                        >
                            Trigger: {rule.trigger.eventType} | Conditions:{' '}
                            {rule.conditions?.length || 0} | Effects:{' '}
                            {rule.effects?.length || 0} | Priority:{' '}
                            {rule.priority ?? 100}
                            <span
                                style={{ color: '#667eea', marginLeft: '8px' }}
                            >
                        ...
                        >
                            ...
                            <div style={{ marginBottom: '20px' }}>
                                ...
                                <div style={{ marginTop: '12px' }}>
                                    ...
                                    >
                                        Additional constraints on event data
                                        (e.g., playerId, cardType)
                                    </div>
                                    {rule.trigger.filters &&
                                        Object.entries(
                                            rule.trigger.filters
                                        ).map(([key, value]) => (
                                            <div
                                    ...
                                    {(!rule.trigger.filters ||
                                        Object.keys(rule.trigger.filters)
                                            .length === 0) && (
                                        <div
                                            style={{
                                                padding: '12px',
                                        ...
                                        >
                                            No filters. Click "+ Add Filter" to
                                            add constraints on event data.
                                        </div>
                                    )}
                                </div>
                            </div>
                            ...
                            <div style={{ marginBottom: '20px' }}>
                                ...
                                >
                                    Additional checks that must pass before rule
                                    effects execute
                                </div>
                                {(rule.conditions || []).map(
                                    (condition, cIndex) => (
            ...
            {rules.length === 0 && (
                ...
                >
                    No rules defined. Rules react to events and execute effects
                    automatically (e.g., switch player on TurnEnded).
                </div>
            )}
        </div>
    );
...
function WinConditionsSection({
    ...
    const updateWinCondition = (
        index: number,
        updates: Partial<WinConditionSchema>
    ) => {
        onChange(
    ...
    return (
        <div>
            ...
            >
                ...
                <button style={styles.successButton} onClick={addWinCondition}>
                    + Add Win Condition
                </button>
            </div>
            ...
            >
                Win conditions are evaluated when <code>isGameOver()</code> or{' '}
                <code>getWinner()</code> is called. The first matching condition
                determines the winner. Conditions are checked in order.
            </div>
                ...
                <div key={index} style={styles.card}>
                    ...
                    >
                        ...
                        <div>
                            ...
                            <select
                                style={styles.input}
                                value={
                                    typeof winCondition.winner === 'string'
                                        ? winCondition.winner
                                        : ''
                                }
                                onChange={e =>
                    ...
                    {expandedCondition !== index && (
                        <div
                            ...
                            onClick={() => setExpandedCondition(index)}
                        >
                            Condition: {winCondition.condition.type} | Winner:{' '}
                            {winCondition.winner || 'none'}
                            <span
                                style={{ color: '#667eea', marginLeft: '8px' }}
                            >
                                Click Expand to edit →
                    ...
                    {expandedCondition === index && (
                        ...
                        >
                            ...
                            <div>
                                ...
                                >
                                    This condition must be true for the game to
                                    end
                                </div>
                                <ConditionBuilder
                            ...
                            <div style={{ marginTop: '16px' }}>
                                ...
                                >
                                    Entity expression for the losing player. If
                                    set, winner will be the other player.
                                </div>
                                <input
                                    style={styles.input}
                                    value={
                                        typeof winCondition.loser === 'string'
                                            ? winCondition.loser
                                            : ''
                                    }
                                    onChange={e =>
                                        updateWinCondition(index, {
                                            loser: e.target.value || undefined,
                                        })
                                    }
            ...
            {winConditions.length === 0 && (
                ...
                >
                    No win conditions defined. Win conditions determine when the
                    game ends and who wins.
                </div>
            )}
        </div>
    );
...
function SetupSection({
    ...
    const updatePerPlayer = (
        updates: Partial<SetupDefinitionSchema['perPlayer']>
    ) => {
    ...
    const removeStartingEntity = (index: number) => {
        const entities = setup.perPlayer.startingEntities || [];
        updatePerPlayer({
            startingEntities: entities.filter((_, i) => i !== index),
        });
    };

    const updateStartingEntity = (
        index: number,
        updates: Partial<{ template: string; zone: string; count: number }>
    ) => {
        const entities = setup.perPlayer.startingEntities || [];
        updatePerPlayer({
            startingEntities: entities.map((e, i) =>
                i === index ? { ...e, ...updates } : e
            ),
        });
    };
    ...
    const removeSharedZoneEntity = (index: number) => {
        const entities = setup.sharedZoneEntities || [];
        updateSetup({
            sharedZoneEntities: entities.filter((_, i) => i !== index),
        });
    };

    const updateSharedZoneEntity = (
        index: number,
        updates: Partial<{ template: string; zone: string; count: number }>
    ) => {
        const entities = setup.sharedZoneEntities || [];
        updateSetup({
            sharedZoneEntities: entities.map((e, i) =>
                i === index ? { ...e, ...updates } : e
            ),
        });
    };
        ...
        <div>
            ...
            <div style={styles.fieldGroup}>
                ...
                <select
                    ...
                    onChange={e =>
                        updateSetup({ initialPhase: e.target.value })
                    }
                >
            ...
            <div style={styles.fieldGroup}>
                ...
                <select
                    ...
                    onChange={e =>
                        updatePerPlayer({ template: e.target.value })
                    }
                >
                ...
                >
                    {perPlayerZones.map(([zoneName]) => (
                        <button
                            ...
                            style={{
                                padding: '6px 12px',
                                background: setup.perPlayer.zones?.includes(
                                    zoneName
                                )
                                    ? '#667eea'
                                    : '#e5e7eb',
                                color: setup.perPlayer.zones?.includes(zoneName)
                                    ? 'white'
                                    : '#374151',
                                border: 'none',
                                borderRadius: '4px',
            ...
            <div style={{ marginTop: '24px' }}>
                ...
                >
                    ...
                    <button
                        style={{ ...styles.button, fontSize: '0.85em' }}
                        onClick={addStartingEntity}
                        disabled={perPlayerZones.length === 0}
                    >
                        + Add
                    </button>
                </div>
                {(setup.perPlayer.startingEntities || []).map(
                    (entity, index) => (
                        <div
                            key={index}
                            style={{
                        ...
                        >
                            ...
                            <button
                                ...
                                onClick={() => removeStartingEntity(index)}
                            >
                                x
                            </button>
                        </div>
                    ...
                    <div style={{ marginTop: '16px' }}>
                        ...
                        >
                            ...
                            <button
                                ...
                                onClick={addSharedZoneEntity}
                            >
                                + Add
                            </button>
                        </div>
                        {(setup.sharedZoneEntities || []).map(
                            (entity, index) => (
                                <div
                                    key={index}
                                    style={{
                        ...
                        {(setup.sharedZoneEntities || []).length === 0 && (
                            ...
                            >
                                No shared zone entities yet. Add entities to
                                populate shared zones like a marketplace or
                                common area.
                            </div>
                        )}
                    </div>
