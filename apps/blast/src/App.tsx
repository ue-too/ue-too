    ...
    return (
        <div className="app">
            ...
            >
                ...
                >
                    <h1
                        style={{ color: 'white', margin: 0, fontSize: '1.5em' }}
                    >
                        Blast Tools
                    </h1>
                    <div
                    ...
                    >
                        ...
                        <button
                            ...
                            style={{
                                ...
                                cursor: 'pointer',
                                fontWeight:
                                    currentPage === 'state-machine' ? 600 : 400,
                            }}
                        >
                        ...
                        <button
                            ...
                            style={{
                                ...
                                cursor: 'pointer',
                                fontWeight:
                                    currentPage === 'object-schema' ? 600 : 400,
                            }}
                        >
                        ...
                        <button
                            ...
                            style={{
                                ...
                                cursor: 'pointer',
                                fontWeight:
                                    currentPage === 'game-builder' ? 600 : 400,
                            }}
                        >
                            Game Builder
                        </button>
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            <p style={{ color: '#666' }}>
                                Create state machines visually with states,
                        ...
                        >
                            ...
                            <p style={{ color: '#666' }}>
                                Define data schemas with primitives, arrays, and
                                nested structures
                            </p>
                        </div>
                        <div
                        ...
                        >
                            ...
                            <p style={{ color: '#666' }}>
                                Create board game definitions visually without
                                writing JSON
                            </p>
                        </div>
                        <div
                        ...
                        >
                            ...
                            <p style={{ color: '#666' }}>
                                Test the board game rule engine with a simple
                                card game
                            </p>
                        </div>
                    </div>
