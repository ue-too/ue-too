...
import type { Effect, Event, GameState, Rule } from '../core/types';
...
export class RuleEngine {
            ...
            try {
                ...
                if (allConditionsPass) {
                    ...
                    for (const effect of rule.effects) {
                        ...
                        const actionContext = this.createActionContextForRule(
                            state,
                            context
                        );
                        ...
                        try {
                            ...
                            if (effect.generatesEvent()) {
                                const newEvent =
                                    effect.createEvent(actionContext);
                                if (newEvent) {
                            ...
                            console.error(
                                `Error applying effect in rule ${rule.id}:`,
                                error
                            );
     ...
     */
    private createActionContextForRule(
        state: GameState,
