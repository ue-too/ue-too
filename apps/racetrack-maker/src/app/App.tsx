      ...
      <div className="container">
        ...
        <div id="hero" className="rounded">
          <div className="text-container">
            ...
            <p>This React app has its own isolated dependencies.</p>
          </div>
        ...
        <div id="middle-content">
          <div id="racetrack-features" className="rounded shadow">
            <h2>Racetrack Maker Features</h2>
            <p>Build amazing racetracks with React components!</p>
            <ul>
              <li>✨ Drag and drop track pieces</li>
              <li>🏁 Start/finish line placement</li>
              <li>🎨 Custom track styling</li>
              <li>💾 Save and load tracks</li>
            </ul>
          </div>
        </div>
